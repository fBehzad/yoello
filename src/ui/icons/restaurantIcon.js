import React from 'react';
 const RestaurantIcon = ({ size = 24, color = '#000', className, ...rest }) => {
  return<svg className={className} xmlns="http://www.w3.org/2000/svg"
             width={size} height={size}
             viewBox="0 0 30 30"
             {...rest}
  >
    <circle cx="23" cy="3" r="1"/><path d="M24,3h-2l-1,10v13.5c0,0.828,0.672,1.5,1.5,1.5h0c0.828,0,1.5-0.672,1.5-1.5V3z"/>
